...
export default function CreateSliderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axiosInstance.post("sliders/", submissionData, {
        headers: {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "An error occurred while creating the slider"
      );
    } finally {
    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold">Add New Slider</h1>
        </div>

        <div className="flex gap-2">
          <Button variant="outline" asChild>
            <Link href="/sliders">Cancel</Link>
          </Button>
          <Button
            type="submit"
            form="slider-form"
      ...
      {success && (
        <Alert className="mb-6 bg-green-50 border-green-200">
          ...
          <AlertDescription className="text-green-700">
            Slider has been added successfully! Redirecting...
          </AlertDescription>
        </Alert>
      )}
