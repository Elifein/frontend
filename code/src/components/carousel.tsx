...
// export function Carousel({ initialSlides }: { initialSlides: Slide[] }) {
...
//         try {
//           const response = await axiosInstance.get("allslides/?status=false")
//           setSlides(response.data.data.sliders.map((s: any) => ({
//             id: s.slider_id,
//             image: s.slider_image,
...
//   if (slides.length === 0) {
//     return <div className="h-[300px] flex items-center justify-center animate-pulse bg-gray-100 rounded">Loading slides...</div>
//   }
